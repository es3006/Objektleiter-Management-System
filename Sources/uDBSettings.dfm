object fDBSettings: TfDBSettings
  Left = 0
  Top = 0
  ...
  object edLibraryLocation: TAdvFileNameEdit
    Left = 16
    Top = 346
    Width = 273
    Height = 21
    ...
    Text = ''
    Visible = True
    OnChange = edLibraryLocationChange
    Version = '1.7.1.3'
