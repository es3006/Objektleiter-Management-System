object FrameWachschiessen: TFrameWachschiessen
  Left = 0
  Top = 0
  Width = 1200
  Height = 800
  ...
  object lvWachschiessen: TAdvListView
    Left = 0
    Top = 60
    Width = 1200
    Height = 600
    ...
    TabOrder = 1
    ViewStyle = vsReport
    OnClick = lvWachschiessenClick
    OnColumnClick = lvWachschiessenColumnClick
    OnCompare = lvWachschiessenCompare
    ...
    OnRightClickCell = lvWachschiessenRightClickCell
    Version = '1.9.1.1'
    ExplicitHeight = 599
  end
